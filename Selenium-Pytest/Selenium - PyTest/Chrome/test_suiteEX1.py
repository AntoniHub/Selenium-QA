...
class TestOpenHome:
    def test_01_openHome(self):
        ...
        driver.get('https://antonio-rodriguez.es')
...
class TestEditUser:
    ...
    def test_10_firstName(self):
        ...
        first.send_keys('Antonio Rodriguez')
        time.sleep(0.3)
    ...
    # Edit input LastName
        ...
        last.send_keys('Antonio Rodriguez')
        time.sleep(0.3)
...
class TestPurchase:
    ...
    # Coporate Name
        ...
        corporate.send_keys('Antonio Rodriguez')
        time.sleep(0.3)
...
class TestEmployees:
    ...
    # Edit firstName
        ...
        nombreEmpleado.send_keys('firstName')
        time.sleep(0.3)
    ...
    def test_19_buscarEmpleado(self):
        ...
        buscarEmpleado.send_keys('Antonio')
        time.sleep(0.8)
...
@pytest.mark.skip(reason="INTERNALERROR cuando se ingresa a /notifications")
...
class TestPhishingCampaign:
    ...
    def test_34_resultadosCampanias(self):
        ...
        buscarCampania.send_keys('Antonio')
        time.sleep(0.8)
